...
/*
std::cout << "### make nonkey frame ###" << std::endl;
std::cout << "# 0: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
	traceNewCoarse(fh);

/*
std::cout << "# 1: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "### make key frame ###" << std::endl;
std::cout << "# -1: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
...
/*
std::cout << "# 2: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 3: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 4: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 5: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 6: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 7: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 8: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
*/
...
/*
std::cout << "# 9: frameHessians.size: " << frameHessians.size() << ", ef->nPoints: " << ef->nPoints << ", ef->nFrames: " << ef->nFrames << ", ef->nResiduals: " << ef->nResiduals << std::endl;
for(int k = 0; k<frameHessians.size(); k++)
    std::cout << "    frame " << k << ": pointHessians.size: " << frameHessians[k]->pointHessians.size() << ", immaturePoints.size: " << frameHessians[k]->immaturePoints.size() << std::endl;
std::cout << std::endl;
