...
//		accSSE_top_A->stitchDoubleMT(red,H,b,this,false,false);
		accSSE_top_A->stitchDoubleMT(H,b,this,false,false);
		resInA = accSSE_top_A->nres[0];
//	}
}
...
//		accSSE_top_L->stitchDoubleMT(red,H,b,this,true,false);
		accSSE_top_L->stitchDoubleMT(H,b,this,true,false);
		resInL = accSSE_top_L->nres[0];
//	}
}
...
//		accSSE_bot->stitchDoubleMT(red, H, b,this,false);
		accSSE_bot->stitchDoubleMT(H, b,this,false);
//	}
}
...
void EnergyFunctional::calcLEnergyPt(int min, int max, double& stats, int tid)
{
...
//        Vec10 stats;
//	memset(&stats, 0, sizeof(Vec10));
        double stats = 0.0;
        calcLEnergyPt(0, allPoints.size(), stats, 0);
	return E+stats;
}
